...
Process Name: QRDemo
PID: 24259
Date: 2013-11-30 10:47:13(GMT+0400)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 24259, uid 5000)

Register Information
r0   = 0x00000010, r1   = 0xabf47138
r2   = 0xabf47138, r3   = 0x0016f76e
r4   = 0x00000010, r5   = 0xabf47138
r6   = 0x001d96c0, r7   = 0x001d5168
r8   = 0x001a5648, r9   = 0x000e46c8
r10  = 0xb447c940, fp   = 0xbebc8d10
ip   = 0xb430d1c5, sp   = 0xbebc8cd8
lr   = 0xb26ac260, pc   = 0xb430d1cc
cpsr = 0x60000030
...
Callstack Information (PID:24259)
Call Stack Count: 24
 ...
 1: QRMessagePort::SendMessage(Tizen::Base::Collection::IMap const*) + 0x8c (0xb26ac260) [/opt/apps/vd84JCg9vN/bin/QRDemo.exe] + 0x7260
 2: Tracker::OnCameraPreviewed(Tizen::Base::ByteBuffer&, unsigned long) + 0x704 (0xb26b11b4) [/opt/apps/vd84JCg9vN/bin/QRDemo.exe] + 0xc1b4
End of Call Stack

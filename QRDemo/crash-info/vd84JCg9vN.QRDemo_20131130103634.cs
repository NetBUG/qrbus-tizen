...
Process Name: QRDemo
PID: 23291
Date: 2013-11-30 10:36:34(GMT+0400)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 23291, uid 5000)

Register Information
r0   = 0x00000066, r1   = 0x00000000
r2   = 0x40df1600, r3   = 0x40df1600
r4   = 0xffff5b22, r5   = 0x00168d38
r6   = 0x00217c20, r7   = 0x0021b1c0
r8   = 0x001eb170, r9   = 0x000e4648
r10  = 0xb447c940, fp   = 0xbebc8d60
ip   = 0x000033a8, sp   = 0xbebc8d38
lr   = 0xb26ab834, pc   = 0xb26ab838
cpsr = 0x60000010
...
000dc000 00469000 rw-p [heap]
ada68000 ada9b000 r-xp /usr/lib/gstreamer-0.10/libgstcoreelements.so
adaa4000 adada000 r-xp /usr/lib/gstreamer-0.10/libgstcamerasrc.so
...
Callstack Information (PID:23291)
Call Stack Count: 23
 0: QRMessagePort::SendMessage(Tizen::Base::Collection::IMap const*) + 0x5c (0xb26ab838) [/opt/apps/vd84JCg9vN/bin/QRDemo.exe] + 0x7838
 1: Tracker::OnCameraPreviewed(Tizen::Base::ByteBuffer&, unsigned long) + 0x628 (0xb26b0be8) [/opt/apps/vd84JCg9vN/bin/QRDemo.exe] + 0xcbe8
End of Call Stack

...
Process Name: QRDemo
PID: 22992
Date: 2013-11-30 10:32:31(GMT+0400)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 22992, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x000059d0
r2   = 0x00000006, r3   = 0x000059d0
r4   = 0x00000006, r5   = 0xb6c3abe4
r6   = 0xb6c3a000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0xfff8bd44
r10  = 0xb6a4b000, fp   = 0x000000b0
ip   = 0xb6a4b4c0, sp   = 0xbebc89e0
lr   = 0xb6b4155c, pc   = 0xb6b3d760
cpsr = 0x20000010
...
Callstack Information (PID:22992)
Call Stack Count: 5
 0: gsignal + 0x3c (0xb6b3d760) [/lib/libc.so.6] + 0x2a760
 1: abort + 0x1ac (0xb6b4155c) [/lib/libc.so.6] + 0x2e55c
 2: __gnu_cxx::__verbose_terminate_handler() + 0xc4 (0xb4c8b1d1) [/usr/lib/libstdc++.so.6] + 0x881d1
 3: __cxxabiv1::__terminate(void (*)()) + 0x4 (0xb4c89d99) [/usr/lib/libstdc++.so.6] + 0x86d99
 4: std::terminate() + 0x10 (0xb4c89db5) [/usr/lib/libstdc++.so.6] + 0x86db5
End of Call Stack

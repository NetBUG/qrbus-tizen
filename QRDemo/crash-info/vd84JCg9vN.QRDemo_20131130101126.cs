...
Process Name: QRDemo
PID: 21034
Date: 2013-11-30 10:11:26(GMT+0400)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 21034, uid 5000)

Register Information
r0   = 0x00000031, r1   = 0x00000000
r2   = 0x40df1600, r3   = 0x40df1600
r4   = 0xffff5c12, r5   = 0x00168cc0
r6   = 0x001d6e60, r7   = 0x001da080
r8   = 0x00147630, r9   = 0x000e45b0
r10  = 0xb447c940, fp   = 0xbebc8e38
ip   = 0x000033a8, sp   = 0xbebc8e10
lr   = 0xb26ab7ec, pc   = 0xb26ab7f0
cpsr = 0x60000010
...
000dc000 003e3000 rw-p [heap]
ac991000 ac9c4000 r-xp /usr/lib/gstreamer-0.10/libgstcoreelements.so
ac9cd000 aca03000 r-xp /usr/lib/gstreamer-0.10/libgstcamerasrc.so
ae360000 ae363000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
afbab000 afbf6000 r-xp /usr/lib/libGLESv1_CM.so.1.1
afbff000 afc27000 r-xp /usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so
...
b2692000 b269c000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
...
Callstack Information (PID:21034)
Call Stack Count: 23
 0: QRMessagePort::SendMessage(Tizen::Base::Collection::IMap const*) + 0x5c (0xb26ab7f0) [/opt/apps/vd84JCg9vN/bin/QRDemo.exe] + 0x77f0
 1: Tracker::OnCameraPreviewed(Tizen::Base::ByteBuffer&, unsigned long) + 0x4e4 (0xb26b07ac) [/opt/apps/vd84JCg9vN/bin/QRDemo.exe] + 0xc7ac
End of Call Stack
